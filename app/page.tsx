...
export default function Home() {
  return (
   <main className="flex text-6xl tracking-widest font-bold font-sans min-h-screen flex-col items-center justify-center text-white bg-slate-900 p-12">
    ...
    <div className="absolute bottom-0 left-0 text-sm  m-20 opacity-40 italic">
        Level-0 
